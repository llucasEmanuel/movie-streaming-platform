Feature: Histórico de Conteúdos Assistidos
    ...
    I want to acessar uma página que liste, em ordem cronológica inversa, todos os vídeos que assisti anteriormente, exibindo a data dos registros
...
Scenario: Registrar múltiplas visualizações do mesmo filme
    ...
    And deve ver a data "26/04/2026" associada ao filme "Casablanca"
    And deve ver a data "25/04/2026" associada ao filme "Casablanca"
